...
import { Calculator, CheckCircle2, Send, ShieldCheck } from "lucide-react";
...
const budgets = [
  "Cosmetic Refresh & Fixture Updates (Powder / Half Bath)",
  "Targeted Renovation (Tub-to-Shower / Vanity & Tile)",
  "Full Standard Bathroom Remodel",
  "Luxury Master Ensuite Transformation & Spa Suite",
  "Custom / Undecided (Need In-Home Recommendation)",
];
