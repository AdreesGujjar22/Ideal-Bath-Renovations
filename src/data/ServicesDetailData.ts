...
export const servicesDetailList: ServiceDetailItem[] = [
  {
    ...
    processSteps: [
      ...
      },
      {
        ...
        description: "Complete water-tight substrate installation followed by laser-aligned porcelain tile, designer shower base creation, and stain-resistant epoxy grouting.",
        duration: "Day 9 - 14",
      },
      {
        number: "05",
...

  {
    ...
    beforeImage: bathroomBeforeImg,
    afterImage: modernPowderRoomImg,
...

  {
    ...
    beforeImage: bathroomBeforeImg,
    afterImage: bathroomReferralImg,
...

  {
    ...
    category: "Repairs & Upgrades",
    tagline: "Elevating your daily routine with smart bidets, LED mirrors, thermostatic shower columns, and luxury fixtures.",
    heroImage: modernPowderRoomImg,
    priceRange: "Complimentary In-Home Estimate",
    ...
    overview:
      "You don't always need a full tear-out to dramatically enhance your bathroom experience. Our bathroom upgrades service delivers targeted, high-impact improvements: high-tech bidet toilet seats with heated seats and warm air drying, anti-fog LED backlit mirrors, whisper-quiet ventilation, thermostatic rainfall shower columns, and designer hardware.",
    detailedParagraphs: [
    ...
    keyBenefits: [
      {
        title: "Thermostatic Rain Shower Columns",
        desc: "Pressure-balanced shower systems featuring wide rainfall heads, body jets, and flexible handheld spray wands.",
      },
      {
    ...
    inclusions: [
      "Thermostatic Rain Shower System & Handheld Wand Installation",
      ...
      "Auto-Sensing Humidity Bathroom Exhaust Fan Replacement",
      "Matte Black, Brushed Gold, or Chrome Designer Towel Warmers",
      "Solid Brass Sink Faucets & Matching Pop-Up Drain Hardware",
    ],
    processSteps: [
      {
        number: "01",
        title: "Circuit & Plumbing Audit",
        description: "We check your electrical panel and plumbing rough-ins to verify capacity for smart mirrors or bidet power.",
        duration: "Day 1",
      },
      {
        number: "02",
        title: "Electrical & In-Wall Rough-In",
        description: "Concealed wiring is pulled through wall cavities for backlit mirrors, towel warmers, and sensors.",
        duration: "Day 2",
      },
      {
        number: "03",
        title: "Fixture Mounting & Shower Plumbing",
        description: "Thermostatic shower columns, vanity mirrors, and luxury accessories are securely installed.",
        duration: "Day 3 - 4",
      },
      {
        number: "04",
        title: "Testing & Smart Feature Setup",
        description: "Smart toilets, shower valves, and smart mirrors are mounted, calibrated, pressure-tested, and synced.",
        duration: "Day 5",
      },
    ],
    beforeImage: bathroomBeforeImg,
    ...
    beforeAfterDesc: "Added an anti-fog backlit LED smart mirror, high-tech bidet toilet suite, and matte black thermostatic shower hardware.",
    materialOptions: [
      {
        title: "Anti-Fog Backlit LED Smart Mirrors",
        description: "Tunable color temperatures, integrated defoggers, and touch-sensitive dimming.",
        badge: "Smart Tech",
      },
      {
